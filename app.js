...
const genreRules = [
  ...
  ['Криминал', /крестн|казино|славные парни|лицо со шрамом|донни браско|гангстер|криминальное|общак|джон уик|карты деньги|джентельмен|рок-н-рольщик|борн|уравнитель|перевозчик|форсаж/i],
